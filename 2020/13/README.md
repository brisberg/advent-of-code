...
This is again a combinatorics problem. Basically we need to find a time `t` such that each increasing time tick is divisible by the bus number. I don't see an obvious solution immediately.
